...
* shift_subtitle.rb uses IO subclasses (such as File and StringIO) to support processing large files
* Time shifting handles boundary cases
  * Shifting 00:00:00,001 down by a second shifts to 00:00:00,000 (perhaps we should show a warning?)
